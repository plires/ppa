...
<head>
    ...
    <title>{name_client}</title> <!-- La etiqueta del titulo se muestra en las notificaciones por correo electronico, como Android 4.4. -->
        ...
        <!-- Header-->
          <tr>
              <td style="vertical-align: middle;">
                  ...
                  <img src="https://ppabsas.com.ar/temporal/img/email/header-mail.jpg" style="margin:0; padding:0; border:none; display:block; width: 100%; height: auto;" border="0" alt="header" />
          ...
          <!-- Texto-->
          <tr style="background-color: #f05900;">
              <td style="padding: 10px; vertical-align: middle;">
                  ...
                  <h1 class="fallback-font" style="margin: 0px!important; font-family: 'Montserrat', sans-serif; font-size: 28px; color: #FFFFFF; text-align: center; font-weight: 700;">
                      <strong>Nueva consulta desde {origin}</strong>
                  </h1>
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px;">
                  ...
                  <h2 class="fallback-font" style="margin: 0 0 5px 0; font-family: 'Montserrat', sans-serif; font-size: 19px; line-height: 29px; color: #575756; text-align: left; font-weight: 700;">
                      <strong>Hola {name_client}</strong>
                  </h2>
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; color: #575756; text-align: left; font-weight: 400;">
                    Recibiste una nueva consulta desde el {origin}
                  </p>
                  <br>
                  <br>
          ...
          <!-- Boton : BEGIN -->
          <tr style="background-color: #f05900;">
              <td style="background-color: #f05900; text-align: center; padding: 40px;">
          ...
          <tr align="center" style="background-color: #FFFFFF;">
              <td align="center"  style="background-color: #FFFFFF;padding: 10px;">
                ...
                <a target="_blank" rel="noopener noreferrer" href="{facebook}">
                  <img src="https://ppabsas.com.ar/temporal/img/email/facebook.png" style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="facebook" />
                </a>

                <a target="_blank" rel="noopener noreferrer" href="{instagram}">
                  <img src="https://ppabsas.com.ar/temporal/img/email/instagram.png" style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="instagram" />
                </a>
