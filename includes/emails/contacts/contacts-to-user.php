                  ...
                  <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                      <tr>
                          <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                              <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener" href="{base}" style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #f05900; display: block; border-radius: 4px;">CONSULTAR
                              </a>
                          </td>
                      </tr>
                  </table>
          ...
          <tr align="center" style="background-color: #FFFFFF;">
              <td align="center"  style="background-color: #FFFFFF;padding: 10px;">
                ...
                <a target="_blank" rel="noopener noreferrer" href="{facebook}">
                  <img src="https://ppabsas.com.ar/temporal/img/email/facebook.png" style="margin:0; padding:0; padding-right: 20px; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="facebook" />
                </a>

                <a target="_blank" rel="noopener noreferrer" href="{instagram}">
                  <img src="https://ppabsas.com.ar/temporal/img/email/instagram.png" style="margin:0; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="instagram" />
                </a>
