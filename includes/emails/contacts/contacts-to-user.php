          ...
          <tr align="center" style="background-color: #FFFFFF;">
              <td align="center"  style="background-color: #FFFFFF;padding: 10px;">
                ...
                <a target="_blank" rel="noopener noreferrer" href="{facebook}">
                  <img src="https://ppabsas.com.ar/img/email/facebook.png" style="margin:0; padding:0; padding-right: 20px; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="facebook" />
                </a>

                <a target="_blank" rel="noopener noreferrer" href="{instagram}">
                  <img src="https://ppabsas.com.ar/img/email/instagram.png" style="margin:0; padding:0; border:none; display:inline-block; width: 16px; height: auto;" border="0" alt="instagram" />
                </a>
